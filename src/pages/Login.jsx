...
const Login = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-violet-500 via-purple-600 to-indigo-500">
        <div className="w-full max-w-md p-8 bg-gray-900 dark:bg-gray-50 shadow-lg rounded-lg transition duration-300 ease-in-out transform hover:-translate-y-1">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-md border border-gray-700 dark:border-gray-300 bg-gray-800 dark:bg-gray-50 text-gray-100 dark:text-gray-800 focus:ring-2 focus:ring-indigo-400"
              />
            </div>
            ...
            <button className="w-full py-3 mt-4 rounded-md bg-violet-500 hover:bg-violet-600 text-gray-100 dark:text-gray-50 font-semibold text-center transition duration-300">
              Sign in
            </button>
          </form>
          ...
          <div className="flex justify-center space-x-4 mt-4">
            ...
            >
              <svg
                ...
                viewBox="0 0 32 32"
                className="w-5 h-5 fill-current text-gray-100 dark:text-gray-900"
              >
