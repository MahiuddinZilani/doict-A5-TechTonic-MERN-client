...
const Registration = () => {
  ...
  return (
    <>
      ...
      <div className="w-full flex justify-center items-center dark:bg-slate-900">
        <div className="w-full max-w-lg p-8 space-y-2 rounded-xl bg-gray-200  shadow-lg text-gray-800">
...
//   return (
//     <div className="w-full flex justify-center items-center px-4 py-10 bg-gray-100">
//       <div className="w-full max-w-md p-8 space-y-4 rounded-xl bg-white shadow-md">
...
//                 className="w-full p-2 border rounded-md focus:ring focus:outline-none focus:ring-blue-300"
//               />
//               {errors[field.name] && (
...
//           <button className="w-full py-2 mt-4 text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:ring-4 focus:ring-blue-300">
//             Register
//           </button>
//         </form>
...
//             Twitter
//           </button>
//           <button className="p-2 rounded-full bg-gray-800 hover:bg-gray-900 text-white">
//             GitHub
//           </button>
//         </div>
